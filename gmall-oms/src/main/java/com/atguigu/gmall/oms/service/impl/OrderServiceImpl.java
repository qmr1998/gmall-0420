...
import com.atguigu.gmall.oms.client.GmallPmsClient;
import com.atguigu.gmall.oms.client.GmallUmsClient;
        ...
        if (!CollectionUtils.isEmpty(items)) {
            itemService.saveBatch(items.stream().map(item -> {
                ...
                if (skuEntity != null) {
                    ...
                    ResponseVo<List<SkuAttrValueEntity>> skuAttrValueResponseVo = this.pmsClient.querySkuAttrValueBySkuId(item.getSkuId());
